...
import { transitionDurationWait } from '@/utils/wheel'
...
class Split {
  ...
  async normalSlideDown() {
    ...
    // await timeout(parseFloat(parentLineHeight) / speed)
    ...
    await timeout(scrollHeight / speed)
  ...
  async normalSlideUp () {
    ...
    await timeout(this.jackTransitionDuration)
